# `VkFFT_OpenCL_jll.jl` (v0.1.0+0)

[![deps](https://juliahub.com/docs/VkFFT_OpenCL_jll/deps.svg)](https://juliahub.com/ui/Packages/General/VkFFT_OpenCL_jll/)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/38e0755860af35bb988cffbb5b27177ef7fd0348/V/VkFFT/VkFFT_OpenCL/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
The tarballs for `VkFFT_OpenCL_jll.jl` have been built from these sources:

* git repository: https://github.com/PaulVirally/libvkfft.git (revision: `8d20a59e32bcacdc8ae09ba71ce4589719cd7257`)

## Platforms

`VkFFT_OpenCL_jll.jl` is available for the following platforms:
...
The following JLL packages are required by `VkFFT_OpenCL_jll.jl`:
